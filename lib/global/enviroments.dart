...
class Enviroments {
  ...
  static String apiUrl=Platform.isAndroid? 'http://192.168.1.131:4000/api': 'http://localhost:3000/api';
  static String soketUrl=Platform.isAndroid? 'http://192.168.1.131:4000': 'http://localhost:3000';
